...
from route_wrapper.integrations.fastapi.response_factory import JSONResponseFactory
from route_wrapper.integrations.fastapi.provider import fastapi_provider


@base_wrapper(
    default_response_factory=JSONResponseFactory,
    web_provider=fastapi_provider,
)
def adaptix_wrapper(
    retort: Retort,
):
